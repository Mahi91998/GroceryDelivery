...
import com.ctc.repository.AdminRepo;
...
public class AdminService {
	...
	/*
	public void fetchbyAdminNameAndPassword(String admin_name, String password) {
		return repo.findbyAdminNameAwordndPass(admin_name, password);
